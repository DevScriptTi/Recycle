...
const ShipppersJoinRequestsSlices = createSlice({
    name:'ShipppersJoinRequests',
    initialState:{
        data : [],
        links : [],
        first_page_url : null,
    ...
    reducers:{
        setShipppersJoinRequests : (state, action)=>{
...
export const {setShipppersJoinRequests} = ShipppersJoinRequestsSlices.actions ;
export default ShipppersJoinRequestsSlices.reducer ; 