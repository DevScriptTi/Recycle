...
import { addPrimaryMatersCategoriesPagination } from "../../../../StateManagement/Slices/newSlices/PrimaryMatersCategoriesPagination/PrimaryMatersCategoriesPaginationSlices";
...
export const CreateOne = () => {
  ...
  const onSubmit = async (data) => {
    try {
      const response = await axiosClient.post("api/primaryMaterCategories", {
        name: data.name,
      });
      dispatch(addPrimaryMatersCategoriesPagination(response.data.data))
