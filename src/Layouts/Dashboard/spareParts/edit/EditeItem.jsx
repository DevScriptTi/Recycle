...
import { updateSparePartsPagination } from "../../../../StateManagement/Slices/newSlices/SparePartsPagination/SparePartsPaginationSlices";
...
export const EditeItem = ({ item }) => {
  ...
  const onSubmit = async (data) => {
    console.log(data);
    try {
      const response = await axiosClient.put(`api/spareParts/${item.id}`, {
        reference: data.reference,
        name: data.name,
        productCategory_id: data[productCategory_id],
      });
      console.log(response.data.data);
      dispatch(updateSparePartsPagination(response.data.data));
