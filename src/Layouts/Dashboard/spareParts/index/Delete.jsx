...
import { deleteSparePartsPagination } from "../../../../StateManagement/Slices/newSlices/SparePartsPagination/SparePartsPaginationSlices";
...
export const Delete = ({ id }) => {
  ...
  const DeleteItem = async () => {
    try {
      ...
      const response = await axiosClient.delete(`api/spareParts/${id}`);
      dispatch(deleteSparePartsPagination(id))
