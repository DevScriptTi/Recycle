...
export const Vendors = () => {
  ...
  const getData = async () => {
    try {
      ...
      const response = await axiosClient(`api/coll-companies?${location.search}`);
  ...
  return (
    <DashboardContent title={"شركات الجمع"}>
      <div className="flex flex-col gap-10 w-full">
        <Stat number={vendors.total} text="عدد شركات الجمع" icon={<User size={50}/>}/>
